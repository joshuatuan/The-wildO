...
function DeleteReservation({ bookingId, onDelete }: DeleteReservationProps) {
  ...
  return (
    <button
      ...
      className="group flex items-center gap-2 px-3 text-xs font-bold uppercase text-primary-300 transition-colors hover:bg-accent-600 hover:text-primary-900 md:flex-grow"
    >
      {!isPending ? (
        <>
